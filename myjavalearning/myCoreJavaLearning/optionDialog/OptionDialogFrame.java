...
public class OptionDialogFrame extends JFrame
{
	...
	public OptionDialogFrame()
	{
		...
		typePanel = new ButtonPanel("Type", "Message", "Comfirm", "Option", "Input");
	...
	/**
	 * The action listener for the Show button shows a Comfirm, Input, Message, or Option dialog
	...
	private class ShowAction implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			else if(typePanel.getSelection().equals("optioin"))
