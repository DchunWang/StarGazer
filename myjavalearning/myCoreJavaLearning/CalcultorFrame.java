...
public class CalcultorFrame extends JFrame
{
	...
	public void setTitle()
	{
		try
		{
			...
			catch(FileNotFoundException e)
			{
				...
				FileContens contents = service.get(key);
	...
	//Opes a history file and updates the diaplay
	...
	public void open()
	{
		try
		{
			...
			FileContens contents = service.openFileDialog(".", new String [] {"txt"});
	...
	public void save()
	{
		try
		{
			...
			FileSavaService service = (FileSaveService) ServiceManager.lookup("javax.jnlp.FileSaveService");
